...
box();
    ...
    printf("Daffodil International University");
     ...
     gotoxy(15,18);
    printf("Facebook: Fb.com/shohidul.i.polash");
     gotoxy(15,19);
    printf("Email : shohidulpolash@live.com");
    //-------------------------------------------------------
     gotoxy(60,15);
   ...
   setcolor(36);
    ...
    printf("Daffodil International University");
     gotoxy(25,14);
    printf("Email : drnoori@daffodilvarsity.edu.bd");
    gotoxy(25,15);
    printf("Web: http://faculty.daffodilvarsity.edu.bd/profile/cse/rashed-haider-noori.html");
